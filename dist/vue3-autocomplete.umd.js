...
;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader/index.js??clonedRuleSet-83.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/Autocomplete.vue?vue&type=template&id=0a3f96d2&scoped=true&ts=true
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", _hoisted_1, [
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withDirectives)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("input", {
            ...
            class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.getInputClass),
        ...
        ($setup.shouldShowResults)
            ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
                key: 0,
                style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)({ width: $setup.inputWidth + 'px' }),
                class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.getResultsContainerClass)
            }, [
                ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($setup.filteredResults, (item) => {
                    return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
                        key: item,
                        class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.getResultsItemClass),
                        onClick: ($event) => ($setup.clickItem(item)),
                        onMousedown: _cache[4] || (_cache[4] = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withModifiers)(() => { }, ["prevent"]))
                    }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.displayItem(item)), 43, _hoisted_2));
                }), 128))
            ], 6))
...
;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader/index.js??clonedRuleSet-83.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/Autocomplete.vue?vue&type=script&lang=ts
...
/* harmony default export */ var Autocompletevue_type_script_lang_ts = ({
    ...
    setup(props, context) {
        const autocompleteRef = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)();
        let inputWidth = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(0);
        let searchText = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('');
        let timeout;
        let showResults = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(true);
        /**
         ...
         */
        const getInputClass = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
            return props.inputClass.length > 0 ? props.inputClass : ['vue3-input'];
        });
        /**
         * Return class(es) for results container element
         */
        const getResultsContainerClass = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
         ...
         */
        const getResultsItemClass = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
         ...
         */
        let shouldShowResults = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
            return showResults.value && (props.results.length > 0);
        });
        /**
         * Return results filtered with the 'max' props
         */
        const filteredResults = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
